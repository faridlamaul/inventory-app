...
<div class="bg-secondary">
    <div class="uk-height-large uk-background-cover uk-light uk-flex" uk-parallax="bgy: -200" style="height: 90vh; background-image: url('https://images.unsplash.com/photo-1553770710-7aa9a1e4f9dd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80');">
        ...
        <div class="mt-5">
            ...
            <div class="bg-dark p-5">
                <dl class="uk-description-list uk-description-list-divider">
                    ...
                    <dt class="text-white">Description term</dt>
                    <dd class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</dd>
                    <dt class="text-white">Description term</dt>
                    <dd class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</dd>
                </dl>
