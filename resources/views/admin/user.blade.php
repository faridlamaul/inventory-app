            ...
            <table class="uk-table uk-table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->telepon }}</td>
                        <td>
                            <button type="button" class="uk-button uk-button-danger" uk-toggle="target: #modal-{{ $user->id }}">Hapus</button>
                            <!-- This is the modal -->
                            <div id="modal-{{ $user->id }}" uk-modal>
                                <div class="uk-modal-dialog uk-modal-body">
                                    <h2 class="uk-modal-title">Hapus User</h2>
                                    <p>Apakah Anda yakin ingin menghapus user <span>{{ $user->name }} ?</span></p>
