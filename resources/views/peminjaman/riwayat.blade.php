                        ...
                        <div>
                            <div class="uk-card uk-card-default">
                                ...
                                <div class="uk-card-body">
                                    ...
                                    <p class="m-0">Waktu peminjaman : <span>{{ $transaksi->start_date }}</span></p>
                                </div>
                            </div>
                        </div>
                    </a>
                        ...
                        <div>
                            <div class="uk-card uk-card-default">
                                ...
                                <div class="uk-card-body">
                                    ...
                                    <p class="cut-text">{{ $transaksi->description }}</p>
                                    <h5>Status barang :
                                        @if ($transaksi->end_date >= \Carbon::now() && $transaksi->start_date <= \Carbon::now()) <span class="uk-text-primary">Dapat digunakan</span>
                                            @else
...
uk-flex-middle" uk-grid>
                        ...
                        <div class="uk-padding-large">
                            ...
                            <div class="uk-margin">
                                @if ($transaksi->end_date == null)
                                <button class="uk-button uk-button-primary" type="button" uk-toggle="target: #modal-{{ $transaksi->id }}">Ajukan Pengembalian</button>
                                @endif
                                <!-- This is the modal -->
                                <div id="modal-{{ $transaksi->id }}" uk-modal>
                                    <div class="uk-modal-dialog uk-modal-body">
                                        ...
                                        <p>
                                            Pastikan Anda benar-benar sudah mengembalikan <span>{{ $transaksi->name }}</span> ke tempat semula
                                        </p>
